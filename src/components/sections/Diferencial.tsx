          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className={`mt-32 md:mt-[220px] relative z-30 w-full flex flex-col items-center entr-cta ${visible ? "is-visible" : ""}`}>
              ...
              <div className="relative group z-[100]">
                {/* O fundo preto sólido abaixo garente que o botão NÃO fique azul por causa do brilho de fundo */}
                ...
                <button 
                  ...
                  className="relative z-10 px-8 md:px-12 py-5 text-[15px] md:text-base font-bold uppercase tracking-wider text-white rounded-full border border-white/20 hover:border-blue-500/50 transition-all duration-300 shadow-[0_0_50px_rgba(6,182,212,0.5)] active:scale-95"
