  ...
  return (
    <section id="diferencial" ref={ref} className="relative min-h-[110vh] z-10 overflow-hidden">
      ...
      <div className={`container relative z-40 pb-20 md:pb-32 mt-16 md:mt-32 flex flex-col items-center entr-cta ${visible ? "is-visible" : ""}`}>
        ...
        <div className="relative group z-[100] w-full md:w-auto px-4 flex justify-center">
          {/* Fundo preto absoluto do interior */}
          <div className="absolute inset-0 bg-[#000000] rounded-full mx-4 md:mx-0" style={{ backgroundColor: '#000000', opacity: 1 }} />
          <button 
            onClick={() => {
            ...
            className="relative z-10 w-full md:w-auto px-8 md:px-12 py-5 text-[15px] md:text-base font-bold uppercase tracking-wider text-white rounded-full border border-white/20 hover:border-blue-500/50 transition-all duration-300 shadow-[0_0_50px_rgba(6,182,212,0.5)] active:scale-95"
            style={{ backgroundColor: "#000000", background: "#000000", opacity: 1 }}
          >
