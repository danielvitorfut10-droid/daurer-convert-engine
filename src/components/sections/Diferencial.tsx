      ...
      <div className={`container relative z-40 pb-20 md:pb-32 mt-16 md:mt-32 flex flex-col items-center entr-cta ${visible ? "is-visible" : ""}`}>
        ...
        <div className="relative group z-[100] w-full md:w-auto px-4 flex justify-center">
          <ShinyButton 
            ...
            className="relative z-10 w-full md:w-auto py-5 px-10 text-[15px] md:text-base font-bold uppercase tracking-widest text-white shadow-[0_0_50px_rgba(6,182,212,0.6)] !bg-[#000000] active:scale-95 flex justify-center items-center"
          >
            <span className="text-white mr-2">SOLICITAR ORÇAMENTO</span>
