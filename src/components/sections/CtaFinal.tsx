            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left order-2 mt-8 lg:mt-0 px-2 lg:px-0">
                ...
                <div className="relative group w-full lg:w-fit">
                  {/* Background fix para Preto OPACO */}
                  ...
                  <ShinyButton 
                    ...
                    className="relative z-10 w-full lg:w-fit text-sm font-bold uppercase tracking-widest !bg-[#000000]"
                  >
                    <span className="text-white">SOLICITAR ANÁLISE</span>{" "}
                    <svg className="w-5 h-5 text-white inline-block ml-1" viewBox="0 0 24 24" fill="currentColor">
