        ...
        <div className={`relative group z-[100] px-4 flex justify-center w-full pointer-events-auto ${visible ? "animate-reveal-fall" : "opacity-0"}`} style={{ animationDelay: '150ms' }}>
          <div className="inline-flex relative z-10">
            <ShinyButton 
              ...
              className="relative z-20 w-auto py-5 px-12 md:py-6 md:px-16 text-[16px] md:text-xl font-bold uppercase tracking-[0.2em] text-white shadow-[0_0_50px_rgba(37,99,235,0.4)] active:scale-95 flex justify-center items-center whitespace-nowrap rounded-full"
            >
              <span className="text-white mr-3 whitespace-nowrap">Analisar minha loja!</span>
              <svg className="w-6 h-6 text-white inline-block opacity-90" viewBox="0 0 24 24" fill="currentColor">
