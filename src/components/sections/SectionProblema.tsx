...
export const SectionProblema = () => {
  ...
  return (
    <section 
      className="bg-black relative pt-16 md:pt-24 pb-8 md:pb-16"
    >
            ...
            <div className="sticky top-16 md:top-20 z-0 w-full flex flex-col justify-start h-[calc(70vh+96px)] md:h-[calc(80vh+112px)] border border-transparent">
              <div
                ...
                style={{
                  ...
                  width: '600px',
                  height: '480px',
                  background: 'conic-gradient(from 180deg at 50% 0%, transparent 0deg, rgba(96,165,250,0.16) 20deg, rgba(147,197,253,0.1) 30deg, rgba(96,165,250,0.16) 40deg, transparent 60deg)',
                  filter: 'blur(28px)',
                }}
              />
          ...
          <div className="col-start-1 row-start-1 w-full mt-12 md:mt-16 relative z-10">
            {problemCardsData.map((card, i) => (
              <ProblemCard 
                ...
                card={card} 
                i={i} 
                neonBorders={neonBorders} 
                neonShadows={neonShadows} 
                neonGlows={neonGlows} 
